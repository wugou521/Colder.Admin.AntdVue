  ...
  >
    <a-spin :spinning="loading">
      <a-form-model ref="form" :model="entity" :rules="rules" v-bind="layout">
        <a-form-model-item label="CollegeId" prop="CollegeId">
          <a-input v-model="entity.CollegeId" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="ClassName" prop="ClassName">
          <a-input v-model="entity.ClassName" autocomplete="off" />
        </a-form-model-item>
        <a-form-model-item label="IconUrl" prop="IconUrl">
